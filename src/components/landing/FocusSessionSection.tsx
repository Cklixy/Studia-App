      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="rounded-4xl sm:rounded-4xl bg-white border border-black/[0.08] shadow-[0_25px_60px_-15px_rgba(0,25,60,0.07)] p-6 sm:p-14 md:p-20 text-center space-y-7 sm:space-y-10">
          ...
          <div className="space-y-3 sm:space-y-4 py-2 sm:py-4">
            <span className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold font-mono text-arctic-slate tabular-nums tracking-tight block">
              25:00
            </span>
          ...
          <div className="pt-1 sm:pt-2 flex justify-center">
            <button
              ...
              className="w-full sm:w-auto btn-apple-primary text-xs sm:text-sm py-3.5 sm:py-4 px-8 sm:px-10 font-semibold apple-tactile inline-flex items-center justify-center gap-2.5 shadow-apple-md rounded-full"
            >
